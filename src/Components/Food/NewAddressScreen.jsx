      ...
      <div className="flex-1 px-4 py-6">
        ...
        <div className="mb-4">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 border border-gray-300 rounded-lg text-base placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
            />
          </div>
        </div>
        ...
        <div className="mb-4">
          ...
          <button
            ...
            className="flex items-center space-x-3 text-orange-600 hover:text-orange-700 transition-colors group"
          >
