...
const HeaderStore = () => {
    ...
    return (
      <header className="px-5 py-7 rounded-b-3xl shadow-xl select-none bg-[#EF5350] text-white">
        ...
        <div className="relative flex bg-white rounded-full overflow-hidden shadow-inner h-14">
          <div
            className="absolute top-0 h-full w-1/2 bg-[#FFCDD2] rounded-full transition-transform duration-500 ease-in-out"
            style={{ transform: 'translateX(0%)' }}
          />
  
          <button
            onClick={() => navigate('/tienda')}
            className="flex-1 text-center font-medium flex items-center justify-center gap-2 text-[#D32F2F] z-10"
          >
