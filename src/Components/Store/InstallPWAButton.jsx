  ...
  return (
    <div className="fixed bottom-5 right-5 z-40 animate-bounce">
      <button
        ...
        className="bg-orange-500 hover:bg-orange-600 text-white font-semibold px-5 py-3 rounded-full flex items-center gap-2 shadow-lg transition-all duration-200 hover:shadow-xl active:scale-95"
