...
const createMarkerIcon = (business) => {
  const html = renderToStaticMarkup(
    <div className="flex flex-col items-center">
      <div className="relative bg-white rounded-full shadow-lg border-2 border-red-600
                      hover:scale-110 transition-transform cursor-pointer">
        <div className="w-10 h-10 flex items-center justify-center">
          <span className="text-xl">{business.emoji}</span>
        </div>
        {business.discount && (
          <div className="absolute -top-1 -right-1 bg-red-600 text-white text-[9px]
...
const createClusterIcon = (count) => {
  ...
  const html = renderToStaticMarkup(
    <div className="relative">
      <div className={`bg-red-600 rounded-full shadow-lg flex items-center justify-center
