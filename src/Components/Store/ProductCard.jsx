  ...
  return (
    ...
    >
      ...
      <div className="relative flex-shrink-0 w-20 h-28">
        ...
        {/* Etiqueta descuento */}
        {hasDiscount && (
          <div className="absolute top-0 -left-2 bg-orange-500 text-white text-[8px] font-bold px-2 py-0.5 rounded-r-lg shadow whitespace-nowrap">
            -{discountPercentage}%
          </div>
        )}
      ...
      <div className="flex flex-col justify-between flex-1 h-28 mx-3 pr-2">
        ...
        <div className="flex items-center justify-between mt-2">
          ...
          <button
            ...
            type="button"
            className={`${buttonColorClass} w-10 h-10 rounded-xl flex items-center justify-center transition-all shadow hover:shadow-md active:scale-95 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-${isTienda ? "orange-500" : "green-500"}`}
          >
            <Plus
