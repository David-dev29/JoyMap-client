...
const CategoryCard = ({ cat, onClick, isExpanded }) => (
  <div
    ...
    className={`group relative bg-gradient-to-br from-gray-50 to-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-200 cursor-pointer active:scale-95 border border-gray-100 ${
      isExpanded ? 'ring-2 ring-rose-600' : ''
    }`}
  >
    <div className="p-4 h-28 flex flex-col justify-between">
      ...
      <div className="flex items-center justify-between relative z-10">
        <span className="text-xs text-gray-500 font-medium group-hover:text-rose-600 transition-colors">
          Ver negocios
        </span>
        <div className="w-6 h-6 rounded-full bg-rose-600 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
    ...
    <div className="absolute inset-0 bg-gradient-to-br from-rose-600/0 to-rose-500/0 group-hover:from-rose-600/5 group-hover:to-rose-500/5 transition-all duration-200"></div>
  </div>
);
...
const BusinessCard = ({ business, onClick, index }) => (
  ...
  >
    {/* Banner del negocio */}
    <div className="relative h-24 bg-gradient-to-br from-rose-100 to-rose-100 overflow-hidden">
      ...
      <div className="absolute -bottom-6 left-4">
        <div className="w-12 h-12 bg-white rounded-xl shadow-lg p-1.5">
          {business.iconImage ? (
            ...
            <div className="w-full h-full bg-rose-100 rounded-lg"></div>
          )}
        </div>
      </div>
    </div>
...
export default function FloatingCategoriesButton({ categories, setActiveCategory, cartItems = [] }) {
  ...
  return (
    <>
      ...
      <button
        onClick={openModal}
        className={`fixed right-6 w-16 h-16 bg-gradient-to-tr from-rose-600 to-rose-500 rounded-full flex flex-col items-center justify-center shadow-2xl z-[50] transition-all duration-200 transform hover:scale-110 active:scale-95 ${
          ...
          <div className="animate-bubbleExpand">
            ...
            <div className="px-6 pb-4">
              <button
                ...
                className="flex items-center gap-2 text-rose-700 font-semibold mb-3 hover:gap-3 transition-all"
              >
                <ChevronLeft size={20} />
              ...
              <div className="flex items-center gap-3">
                {selectedCategory.iconImage && (
                  <div className="w-14 h-14 bg-gradient-to-br from-rose-100 to-rose-100 rounded-2xl p-2 shadow-md">
                    <img
